...
plot_vs_only_dyn(pg_ieee96, β_96_u, β_96, eβ_96_u, eβ_96, L"\beta_{u}", L"\beta", colorant"mediumorchid", [0.725, 1])
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/snbs_96_all_vs_u"))

plot_vs_only_dyn(pg_ieee96, β_96_u, β_96_ω , eβ_96_u, eβ_96, L"\beta_{u}", L"\beta_{\omega}", colorant"coral1", [0.725, 1])
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/snbs_96_omgea_vs_u"))

plot_vs_only_dyn(pg_ieee96, σ_96_u, σ_96, eσ_96_u, eσ_96, L"\sigma_u", L"\sigma", colorant"steelblue", [0.725, 1])
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/surv_96_all_vs_u"))

plot_vs_only_dyn(pg_ieee96, σ_96_u, σ_96_ω, eσ_96_u, eσ_96, L"\sigma_u", L"\sigma_{\omega}",  colorant"teal", [0.725, 1])
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/surv_96_omgea_vs_u"))
...
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/snbs_96_histogram"))
...
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/surv_96_histogram"))

plot_vs_only_dyn(pg_ieee96, β_96, σ_96, eβ_96, eσ_96, L"\beta", L"\sigma",colorant"darkorchid3", [0.725, 1])
png(joinpath(@__DIR__,"../plots/ieee96/-5, 5/snbs_surv_96_all"))
...
g = pg_ieee96.graph
path = joinpath(@__DIR__, "../plots/ieee96/-5, 5/")
...
g = pg_ieee96.graph
f, ax, p = graphplot(g, node_size = β_96 * 20, node_color = node_color_snbs)
hidedecorations!(ax); hidespines!(ax)
ax.aspect = DataAspect()
FileIO.save(path * "graph_snbs.png", f)

f, ax, p = graphplot(g, node_size = σ_96 * 20, node_color = node_color_surv)
hidedecorations!(ax); hidespines!(ax)
ax.aspect = DataAspect()
